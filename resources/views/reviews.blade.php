    ...
    <div class="row gap-5">
        @foreach ($reviews as $el)
            <div class="alert alert-warning col">
                ...
                <p>{{ $el->email }}</p>
                <p>{{ $el->massage }}</p>
                Периодически отваливается подключение к базе данных, сайт на wordpress. Через некоторое время подключение
                само восстанавливается. В чем может быть причина? при заходе на сайт стандартная ошибка wp "Ошибка установки
